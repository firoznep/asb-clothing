  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        imageUrl:
          process.env.PUBLIC_URL + '/images/shop-img/sneakers/yeezy.png',
        price: 280,
      },
      {
        id: 12,
    ...
    items: [
      {
        ...
        imageUrl:
          process.env.PUBLIC_URL + '/images/shop-img/womens/blue-tank.png',
        price: 25,
      },
      {
        id: 24,
        ...
        imageUrl:
          process.env.PUBLIC_URL + '/images/shop-img/womens/floral-blouse.png',
        price: 20,
      },
      {
        id: 25,
        ...
        imageUrl:
          process.env.PUBLIC_URL + '/images/shop-img/womens/floral-skirt.png',
        price: 80,
      },
      {
        id: 26,
      ...
      },
      {
        ...
        imageUrl:
          process.env.PUBLIC_URL + '/images/shop-img/womens/white-vest.png',
        price: 20,
      },
    ],
  },
    ...
    items: [
      {
        ...
        imageUrl:
          process.env.PUBLIC_URL + '/images/shop-img/mens/camo-vest.png',
        price: 325,
      },
      {
        id: 31,
        ...
        imageUrl:
          process.env.PUBLIC_URL + '/images/shop-img/mens/floral-shirt.png',
        price: 20,
      },
      {
        id: 32,
        ...
        imageUrl:
          process.env.PUBLIC_URL + '/images/shop-img/mens/long-sleeve.png',
        price: 25,
      },
      {
        id: 33,
        ...
        imageUrl:
          process.env.PUBLIC_URL + '/images/shop-img/mens/pink-shirt.png',
        price: 25,
      },
      {
        id: 34,
      ...
      },
      {
        ...
        imageUrl:
          process.env.PUBLIC_URL + '/images/shop-img/mens/polka-dot-shirt.png',
        price: 25,
      },
    ],
  },
